...
import core.utils.export.DailyActivityReportExportUtils;
        ...
        if (userSelection == JFileChooser.APPROVE_OPTION) {
            ...
            BackgroundTask task = new BackgroundTask(this, "Exporting Report as " + format) {
                ...
                protected Boolean performTask() throws Exception {
                    ...
                    if ("XLSX".equalsIgnoreCase(format)) {
                        DailyActivityReportExportUtils.exportToXLSX(currentReportData, fileToSave);
                    } else {
                        DailyActivityReportExportUtils.exportToPDF(currentReportData, fileToSave);
                    }
                    return true;
                }

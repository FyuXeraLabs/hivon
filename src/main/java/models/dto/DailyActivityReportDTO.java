 ...
 * Holds receipt, issue, transfer, adjustment summaries, worker productivity, exception counts and detailed activity log entries
 * @author Sanod
 */
public class DailyActivityReportDTO {
    ...
    public static class ActivityLogItem {
        ...
        public ActivityLogItem(String time, String user, String activityType, String material, double quantity, String from, String to, String status) {
            this.time = time;
            this.user = user;
